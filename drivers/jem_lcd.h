...
#define MAX_DELAY_COUNTER       100000
...
#define REGM_DISPC		9
#define REGM_DSI		8
#define LP_CLK_DIV		17

#define DSI_VACT		LCD_HIGHT
#define DSI_TL			1116

#define LCD_BPP			3 /* Set RGB888 for uboot */
...
#define THS_PREPARE		26
#define THS_PREPARE_THE_ZERO	60
#define THS_TRAIL		25
#define THS_EXIT		48
#define TLPX_HALF		9
#define TCLK_TRAIL		22
#define TCLK_PREPARE		22
#define TCLK_ZERO		87
#define TCLK_POST		(N2DDR(60) + 26)
#define DIV_ROUND_UP(n,d)	(((n) + (d) - 1) / (d))
#define DDR_CLK_PRE 		(DIV_ROUND_UP(20 + 2*TLPX_HALF + TCLK_ZERO + TCLK_PREPARE, 4))
#define DDR_CLK_POST		(DIV_ROUND_UP(TCLK_POST + THS_TRAIL, 4) + 2)
