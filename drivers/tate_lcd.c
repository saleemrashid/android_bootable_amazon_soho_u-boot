...
//**************************************************************************************
static void tate_Init_LCD(void)
{
...
/* initlogo.rle data */
extern u_int16_t const _binary_initlogo_tate_rle_start[];
extern u_int16_t const _binary_initlogo_tate_rle_end[];
/* lowbattery.gz data */
...
extern u_int16_t const _binary_devicetoohot_rle_start[];
extern u_int16_t const _binary_devicetoohot_rle_end[];
/* fastboot.gz data */
extern u_int16_t const _binary_fastboot_tate_gz_start[];
extern u_int16_t const _binary_fastboot_tate_gz_end[];
/* provfailed.rle data */
extern u_int16_t const _binary_provfailed_rle_start[];
extern u_int16_t const _binary_provfailed_rle_end[];
...
.binary_initlogo_rle_start 	=(u_int16_t *)_binary_initlogo_tate_rle_start,
.binary_initlogo_rle_end	=(u_int16_t *)_binary_initlogo_tate_rle_end,
.binary_provfailed_rle_start	=(u_int16_t *)_binary_provfailed_rle_start,
.binary_provfailed_rle_end	=(u_int16_t *)_binary_provfailed_rle_end,
.binary_devicetoohot_rle_start	=(u_int16_t *)_binary_devicetoohot_rle_start,
.binary_devicetoohot_rle_end	=(u_int16_t *)_binary_devicetoohot_rle_end,
...
.binary_devicetoohot_gz_start	=(void *) NULL,
.binary_fastboot_gz_start	=(void *)_binary_fastboot_tate_gz_start,
.binary_multi_download_gz_start	=(void *) NULL,
} ;
...
{
	printf("Tate display registered\n");
