...
/*
 * The ramdisk offset is taken from bootimg
 */
#define RAMDISK_OFFSET	(0x02000000)
#define RAMDISK_SIZE		(0x00800000)
#define GUNZIP_BUFFER_ADDR	(OMAP44XX_DRAM_ADDR_SPACE_START + \
					 RAMDISK_OFFSET + RAMDISK_SIZE)
#define GUNZIP_BUFFER_SIZE	(0x00800000)
#define FRAME_BUFFER_ADDR	(GUNZIP_BUFFER_ADDR + GUNZIP_BUFFER_SIZE)
...
#define GPIO_LCD_ENABLE_35		35	/* enabling LCD panel */
#define GPIO_BACKLIGHT_PWM_190		190	/* GPTimer 10 */
#define GPIO_TST_LED_41		41	/* enabling LCD switch */
//From EVT2
#define GPIO_LCD_ENABLE_190		190 	/* enabling LCD panel */
#define GPIO_BACKLIGHT_PWM_35		35	/* enabling backlight */
...
// Backlight control
//----------------------------------------------------------
#define LP855x_I2C_BUS			1
#define LP855x_I2C_ADDR		0x2C
...
#define LP8557_MAXCURR				0x11
#define LP8557_EPROM_START			0x10
#define LP8557_EPROM_END			0x1E
#define LP8557_EPROM_ADDR4		0x14

#define LP8557_CURRENT				0x05
#define LP8557_BRT_LEVEL			0x0F
#define LP8557_PWM_ONLY				(0x0)
#define LP8557_I2C_CONFIG			(0x1) /* I2C ONLY */
#define LP8557_PWM_I2C				(0x2)
#define LP8557_UNSHAPED_PWM			(0x3)
#define LP8557_PWM_FILTER			(1<<6)
#define LP8557_PLAT_CONFIG			(LP8557_UNSHAPED_PWM | LP8557_PWM_FILTER)
#define LP8557_EPROM_CONFIG		0xDF

//-------------------------------------------------------------
// NT50169 defines
//-------------------------------------------------------------

#define NT50169_I2C_BUS			1

#define NT50169_I2C_ADDR		0x4F
#define NT50169_I2C_REG_0E		0x0E
#define NT50169_I2C_REG_10		0x10
#define NT50169_I2C_REG_1F		0x1F

#define NT50169_RELOAD_FLASH		0x01
