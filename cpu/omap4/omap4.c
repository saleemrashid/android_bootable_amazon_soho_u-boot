...
void s_init(void)
{
	...
	set_muxconf_regs(); /* Reconfig Pin mux.*/
#endif
}
#ifdef CONFIG_BOWSER_BACKLIGHT_PWM
struct dmtimer_platform_data dmtimer10_pdata = {
	.id = OMAP_DMTIMER_10,
	.timer_ip_type = OMAP_TIMER_IP_VERSION_1,
	.needs_manual_reset = 0,
	.io_base = OMAP44XX_GPT10,
	.fclk_reg = DMTIMER10_FCLK,
};
...
static struct bowser_backlight_platform_data bowser_backlight_data = {
	...
	.gpio_vol_o2m = -1,
	.gpio_cabc_en = -1,
	.timer       = OMAP_DMTIMER_10, /* use GPTimer 10 for backlight */
	...
	.initialstep = 255        /* initial brightness */
};
#endif
...
{
#ifdef CONFIG_BOWSER_BACKLIGHT_PWM
	if (!omap_dm_timer_init(&dmtimer10_pdata))
		bowser_backlight_init(&bowser_backlight_data);
#endif
...
#if !defined(CONFIG_MACH_OTTER2) && !defined(CONFIG_MACH_BOWSER)
...
#if defined(CONFIG_MACH_BOWSER_SUBTYPE_TATE) || defined (CONFIG_MACH_BOWSER)
	Set_Brightness(1);
#endif
	return 0;
}
