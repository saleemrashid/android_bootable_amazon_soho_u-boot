...
#if defined(CONFIG_MACH_BOWSER_SUBTYPE_JEM) || defined (CONFIG_MACH_BOWSER) || defined(CONFIG_MACH_BOWSER_SUBTYPE_SOHO) // bowser 7 is same as Jem 
...
void configure_mpu_dpll(u32 clk_index)
{
...
void scale_reinit_vcores(u32 chrg_state)
{
	...
	if(0x1 == chrg_state )
		__raw_writel(0x215512, 0x4A307BA0);
	else
		__raw_writel(0x315512, 0x4A307BA0);
	...
	if(0x1 == chrg_state )
		__raw_writel(0x1B4912, 0x4A307BA0);
	else
		__raw_writel(0x2A4912, 0x4A307BA0);
	...
	if(0x1 == chrg_state )
		__raw_writel(0x1C5B12, 0x4A307BA0);
	else
		__raw_writel(0x2B5B12, 0x4A307BA0);
