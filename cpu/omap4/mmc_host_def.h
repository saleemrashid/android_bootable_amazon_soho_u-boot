...
#define MAX_ADMA_LENGTH		((int) ((int) (0xffff / 4) * 4))
#define MAX_ADMA_TABLE		((int) ((0xffff * 512 + MAX_ADMA_LENGTH - 1) / MAX_ADMA_LENGTH))

#define MMC_DATA_READ		1
#define MMC_DATA_WRITE		2
#define MMC_DATA_ADMA		4
#define MMC_DATA_NONE		0
...
#define AUTHENTICATION_CHECK    (0x0)
#define BAD_BLK                 (0x08)
#define BLK_ERASE_CNT           (0x10)
#define MLC_ERASE_CNT           (0x11)
#define SLC_ERASE_CNT           (0x12)
#define BAD_BLK_INFO            (0x40)
#define BLK_ERASE_CNT_TBL       (0x41)
#define BLK_ERASE_CNT_RET       (0x42)
#define BLK_ADD_RET             (0x43)
#define BUFFER_BLK_REFRESH      (0x53)
